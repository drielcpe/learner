// app/payments/students/pay/[id]/page.tsx
"use client"
      ...
      try {
        ...
        if (studentId) {
          ...
          if (paymentResult.success) {
            ...
            if (paymentId) {
              currentPayment = paymentResult.data.find((p: any) => p.id.toString() === paymentId)
  ...
  const handlePaymentComplete = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        window.location.href = "/payments/student"
      } else {
        ...
        <div className="bg-white p-6 rounded-lg border-2 border-dashed border-gray-300 inline-block">
          {imageError ? (
            ...
            <img 
              ...
              className="mx-auto max-w-[250px] h-auto border rounded-lg"
      ...
      <ProtectedRoute requiredRole="student">
        <div className="container mx-auto py-6">
          ...
          <Button className="mt-4" asChild>
            <a href="/payments/students">Back to Payments</a>
          </Button>
        </div>
      </ProtectedRoute>
    )
              ...
              {!paymentMethod?.instructions && paymentMethod?.has_qr && (
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <ol className="text-sm text-blue-700 space-y-1 list-decimal list-inside">
                    ...
                    <li>Verify the amount: ₱{paymentData.amount.toLocaleString()}</li>
                    <li>Add your student ID ({paymentData.student_id}) in the reference field if prompted</li>
                    <li>Confirm and complete the payment</li>
                    <li>Save the reference number from your payment confirmation</li>
                  </ol>
                </div>
              )}
              ...
              {isSubmittedForApproval ? (
                ...
                <div className="border-t pt-6">
                  <div className="text-center space-y-4">
                    ...
                    <Button 
                      variant="outline" 
                      onClick={() => window.location.href = "/payments/student"}
                      className="w-full"
                    >
                      Back to Payments
                    </Button>
